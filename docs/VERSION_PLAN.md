...
| Current implementation | 0.8.0.dev0 | `develop/v0.8.0` | WP-11 structured template studio complete; WP-12 evaluation and release hardening remain | Local evaluation only |
