...
| Current research | 0.9.0 | `research/v0.9.0` | Enterprise design plus WP-01 PostgreSQL parity, WP-02 identity, WP-03 OIDC and WP-04 capability RBAC implemented | Not deployable |
...
- `research/v0.9.0` contains enterprise architecture plus reversible research
  prototypes. WP-01 through WP-04 may add tests, migrations and authorization seams, but
