...
| Current implementation | 0.8.0.dev0 | `develop/v0.8.0` | Increment B persistence/lifecycle complete; session and runtime integration remain | Local evaluation only |
