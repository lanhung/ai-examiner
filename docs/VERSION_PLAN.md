...
| Current research | 0.9.0 | `research/v0.9.0` | Enterprise design plus WP-01 through WP-08, including RLS, object storage, durable jobs and immutable audit, implemented | Not deployable |
