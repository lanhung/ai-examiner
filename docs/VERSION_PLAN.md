...
| Current research | 0.9.0 | `research/v0.9.0` | Enterprise design plus WP-01 through WP-06, including RLS and tenant object storage, implemented | Not deployable |
...
- `research/v0.9.0` contains enterprise architecture plus reversible research
  prototypes. WP-01 through WP-06 may add tests, migrations and authorization seams, but
