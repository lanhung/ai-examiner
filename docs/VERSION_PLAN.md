...
| Current implementation | 0.8.0.dev0 | `develop/v0.8.0` | Increment A contract/compiler foundation complete; full v0.8 remains in development | Local evaluation only |
