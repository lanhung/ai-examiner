...
| Current research | 0.9.0.dev0 | `research/v0.9.0` | WP-01 through WP-14 implemented; 21 release checks pass, 24-hour observation is running, desktop/mobile browser evidence remains | OIDC staging only |
