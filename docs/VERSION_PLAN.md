...
| Current implementation | 0.8.0.dev0 | `develop/v0.8.0` | WP-10 safe transfer and semantic diff complete; structured UI and release hardening remain | Local evaluation only |
