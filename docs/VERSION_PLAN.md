...
| Current implementation | 0.8.0.dev0 | `develop/v0.8.0` | WP-11 complete; WP-12 deterministic and provider gates pass, relevance and deployment rehearsal remain | Local evaluation only |
