...
| Current research | 0.9.0 | `research/v0.9.0` | WP-01 through WP-13 implemented; enterprise UI deterministic gates and Linux recovery pass, WP-14/Vultr evidence remain | Staging rehearsal only |
