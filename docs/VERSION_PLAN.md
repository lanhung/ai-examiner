...
| Current implementation | 0.8.0.dev0 | `develop/v0.8.0` | WP-11 complete; WP-12 runtime relevance path added, but 30-case reciprocal three-template and deployment gates remain | Local evaluation only |
