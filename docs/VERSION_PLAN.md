...
| Current implementation | 0.8.0.dev0 | `develop/v0.8.0` | Increment C session binding and immutable replay snapshots complete; behavior integration remains | Local evaluation only |
