...
| Current implementation | 0.8.0.dev0 | `develop/v0.8.0` | WP-08 template assessment and report integration complete; built-in scenario expansion remains | Local evaluation only |
