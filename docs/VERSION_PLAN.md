...
| Current implementation | 0.8.0.dev0 | `develop/v0.8.0` | WP-09 reviewed built-in scenario set complete; API/import/UI and release hardening remain | Local evaluation only |
